...
│   │   ├── runview.go                    #   `v`: watch a run — WORKFLOWS rows, run picker, step list + tail-followed log, pause/cancel/gate/takeover
